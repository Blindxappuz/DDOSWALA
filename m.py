    ...
    if user_id in admin_id:
        ...
        if len(command) > 1:
            ...
            if user_to_add not in allowed_user_ids:
                ...
                response = f"User {user_to_add} 𝘼𝙙𝙙𝙚𝙙 𝙎𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮(𝙐𝙎𝙀𝙍 𝘾𝙊𝙉𝙉𝙀𝘾𝙏𝙀𝘿🛜)."
            else:
    ...
    if user_id in admin_id:
        ...
        if len(command) > 1:
            ...
            if user_to_remove in allowed_user_ids:
                ...
                response = f"User {user_to_remove} 𝙧𝙚𝙢𝙤𝙫𝙚𝙙 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮✅."
            else:
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 5000:
                ...
                response = f"𝙱𝙶𝙼𝙸 𝙰𝚝𝚝𝚊𝚌𝚔 𝙵𝚒𝚗𝚒𝚜𝚑𝚎𝚍. Target: {target} Port: {port} Time: {time}"
        else:
            response = "Usage :- /bgmi <target> <port> <time>\nBy @𝐙𝐞𝐫𝐨𝐱💎"  # Updated command syntax
    else:
